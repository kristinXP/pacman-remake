/*
 * Class derived from the Slimes class that is responsible for the Purple Slimes movement and actions
 */
...
public:
	...
	//outputs the sprite of the purple slime into the GUI window
	void draw(sf::RenderWindow& window);

	//controls the movement of the Purple Slime 
